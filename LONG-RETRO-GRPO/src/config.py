...
class Stage1Config:
    ...
    # Long-memory specifics
    memory_hard_prompt_threshold: float = 0.25
    memory_solve_rate_ema_alpha: float = 0.3
    memory_ttl: int = 3
    memory_decay_factor: float = 0.6
    memory_dropout_rate: float = 0.1
    memory_max_tokens: int = 192
    memory_failure_mode_count: int = 3
    memory_refresh_max_new_tokens: int = 320
    ...
    gpu: str = "L40S"
    wandb_project: str = "long-retro-grpo-poc"
